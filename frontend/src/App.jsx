         ...
         <div ref={printRef}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid #ddd" }}>
              ...
              <tbody>
                {bills.map(b => (
                  <tr key={b._id}>
                    <td style={{ padding: 8, border: "1px solid #ddd", color: "#1a1a1a" }}>{formatDate(b.billDate)}</td>
                    <td style={{ padding: 8, border: "1px solid #ddd", color: "#1a1a1a" }}>#{String(b.billNumber).padStart(4, "0")}</td>
                    <td style={{ padding: 8, border: "1px solid #ddd", color: "#1a1a1a" }}>{b.party?.companyName}</td>
                    <td style={{ padding: 8, border: "1px solid #ddd", textAlign: "right", color: "#1a1a1a" }}>{formatCurrency(b.grandTotal)}</td>
                  </tr>
                ))}
              </tbody>
              <tfoot>
